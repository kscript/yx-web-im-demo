    ...
    switch (msg.type) {
        ...
        case 'image':
            if (msg.status === -1) {
                ...
                //     url: msg.file.url
                // })
                // str = '<a href="' + msg.file.url + '?imageView" target="_blank"><img data-src="' + msg.file.url + '" src="' + msg.file.url + '?imageView&thumbnail=200x0&quality=85"/></a>';
                str = '<a href="' + url + '" target="_blank"><img data-src="' + url + '" src="' + url + '?imageView&thumbnail=200x0&quality=85"/></a>';
            }
            break;
        case 'file':
            if (msg.status === -1) {
...
return {
    ...
    delCookie: delCookie,
    buildSessionMsg: buildSessionMsg,
